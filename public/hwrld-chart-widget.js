...
/***/ function(module, exports, __webpack_require__) {
	...
	_fetchMock2.default.mock('http://helloworld.com.au/api/line-chart', 'POST', function (url, data) {
	...
	var HwrldChartWidget = function () {
		function HwrldChartWidget(element, options) {
			_classCallCheck(this, HwrldChartWidget);
		...
		_createClass(HwrldChartWidget, [{
			...
			value: function process(json) {
				...
				var firstObj = json.items[0],
				    lastObj = json.items[json.items.length - 1],
				    minY = (_Math = Math).min.apply(_Math, _toConsumableArray(json.items.map(function (val) {
					return val.y;
				})));
			...
			value: function renderElm() {
				_reactDom2.default.render(_react2.default.createElement(_chart2.default, { chart: this.chart, options: this.options }), document.querySelector(this.element));
			}
		}]);

		return HwrldChartWidget;
	}();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactChartist = __webpack_require__(178);
	...
	var Chart = (_dec = (0, _reactStyleable2.default)(_chart2.default), _dec(_class = function (_Component) {
	  ...
	  _createClass(Chart, [{
	    ...
	    value: function render() {
	      ...
	      var chartData = {
	        labels: this.props.chart.items.map(function (val) {
	          return new Date(val.x).toDateString().substring(4, 7).toUpperCase();
	        }),
	        series: [this.props.chart.items.map(function (val) {
	          return val.y;
	        })]
	      };

	      var chartOptions = {
	        high: (_Math = Math).max.apply(_Math, _toConsumableArray(this.props.chart.items.map(function (val) {
	          return val.y;
	        }))) + offset[this.props.options.content].max,
	        low: (_Math2 = Math).min.apply(_Math2, _toConsumableArray(this.props.chart.items.map(function (val) {
	          return val.y;
	        }))) - offset[this.props.options.content].min,
	        showArea: true,
	        showLine: true,
	        showPoint: true,
	        fullWidth: true,
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'hwrld-widget ' + this.props.css['hwrld-widget'] + ' ' + this.props.css[this.props.options.content] },
	        _react2.default.createElement(
	          'div',
	          { className: this.props.css.title },
	          this.props.options.content
	        ),
	        _react2.default.createElement('div', { className: this.props.css['y-axis'] }),
	        _react2.default.createElement(_reactChartist2.default, { data: chartData, options: chartOptions, type: chartType })
	      );
	    }
	  }]);
	...
	var ChartistGraph = (function (_Component) {
	  ...
	  _createClass(ChartistGraph, [{
	    ...
	    value: function updateChart(config) {
	      var Chartist = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js?modules&localIdentName=[local]---[hash:base64:5]!./../node_modules/cssnext-loader/index.js!./../node_modules/sass-loader/index.js!./chart.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js?modules&localIdentName=[local]---[hash:base64:5]!./../node_modules/cssnext-loader/index.js!./../node_modules/sass-loader/index.js!./chart.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".hwrld-widget---27sC9 {\n  background-color: #ffffff;\n  border: 1px solid #ccc;\n  max-width: 978px;\n  position: relative; }\n  .hwrld-widget---27sC9 .title---2rxtF {\n    border-bottom: 1px solid #cccccc;\n    color: #666666;\n    font-size: 16px;\n    height: 38px;\n    left: 0;\n    line-height: 36px;\n    position: absolute;\n    text-align: center;\n    text-transform: capitalize;\n    top: 0;\n    width: 100%; }\n  .hwrld-widget---27sC9 .y-axis---ivwCy {\n    border-right: 1px solid #ccc;\n    height: 126px;\n    left: 0;\n    position: absolute;\n    bottom: 0;\n    width: 30px; }\n  .hwrld-widget---27sC9 .ct-line {\n    fill: none;\n    stroke-dasharray: 2,2;\n    stroke-width: 1px; }\n  .hwrld-widget---27sC9 .ct-label {\n    color: #000000;\n    font-size: 10px; }\n  .hwrld-widget---27sC9.weather---8WDY2 .ct-line {\n    stroke: #E71939; }\n  .hwrld-widget---27sC9.weather---8WDY2 .ct-area {\n    fill: #f8d5da; }\n  .hwrld-widget---27sC9.price---1vPbf .ct-line {\n    stroke: #00B26B; }\n  .hwrld-widget---27sC9.price---1vPbf .ct-point {\n    stroke: #00B26B;\n    stroke-linecap: round;\n    stroke-width: 4px; }\n  .hwrld-widget---27sC9.price---1vPbf .ct-area {\n    fill: #cdf3e4; }\n  .hwrld-widget---27sC9.popularity---Aw9pn .ct-line {\n    stroke: #00BCE4; }\n  .hwrld-widget---27sC9.popularity---Aw9pn .ct-point {\n    stroke: #00BCE4;\n    stroke-linecap: round;\n    stroke-width: 4px; }\n  .hwrld-widget---27sC9.popularity---Aw9pn .ct-area {\n    fill: #ecf5fb; }\n", ""]);

	// exports
	exports.locals = {
		"hwrld-widget": "hwrld-widget---27sC9",
		"title": "title---2rxtF",
		"y-axis": "y-axis---ivwCy",
		"weather": "weather---8WDY2",
		"price": "price---1vPbf",
		"popularity": "popularity---Aw9pn"
	};
